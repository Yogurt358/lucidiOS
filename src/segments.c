...
gdt_descriptor_t gdt_desc[7] __attribute__((aligned));
gdtr_t gdt_reg;
...
void init_gdt() {
    ...
    set_segment(1,0b1001101,0b0010); // Kernel CS
    set_segment(2,0b1111101,0b0010); // User CS
    set_segment(3,0b1001001,0b0100); // Kernel DS
    set_segment(4,0b1111001,0b0100); // User DS
